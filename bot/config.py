...
def load_config() -> Config:
    ...
    config = Config(
        ...
        download=DownloadConfig(
            ...
            fastdl_connections=int(os.getenv("FASTDL_CONNECTIONS") or os.getenv("ARIA2C_CONNECTIONS") or "16"),
            fastdl_split=int(os.getenv("FASTDL_SPLIT") or os.getenv("ARIA2C_SPLIT") or "16"),
            fastdl_min_split_size=os.getenv("FASTDL_MIN_SPLIT_SIZE") or os.getenv("ARIA2C_MIN_SPLIT_SIZE") or "1M",
